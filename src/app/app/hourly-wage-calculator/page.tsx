...
const pageProps = {
  ...
  instructions: `To convert a monthly salary into an hourly wage, divide the monthly salary by the divisor specified in the employment contract, or based on the average monthly work hours. An average full-time employee (working 40 hours per week) typically works around 173 hours per month. Enter your monthly salary and your monthly work hours, and the calculator will determine your hourly wage. You can use either gross or net salary for the calculation.`,
  Info,
};
