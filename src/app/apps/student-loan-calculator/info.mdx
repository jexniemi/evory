...
<FAQ items={[
  ...
  },
  {
    ...
    a: "Refinancing can save money if you qualify for a lower interest rate — especially for high-rate private loans. However, refinancing federal loans into a private loan means losing access to income-driven repayment plans, Public Service Loan Forgiveness (PSLF), and federal deferment/forbearance options. Only refinance federal loans if you have stable income and don't need those federal protections."
  }
]} />
