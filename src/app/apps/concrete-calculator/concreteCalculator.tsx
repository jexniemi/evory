...
const calculate = (values: number[]) => {
  ...
  const bags80lb = cubicFeet / 0.6; // one 80-lb bag covers 0.60 cu ft
  return [
    {
      result: cubicYards,
    ...
    {
      result: Math.ceil(bags60lb),
      label: "60-lb Bags Needed",
      suffix: " bags",
      decimals: 0,
    },
    {
      result: Math.ceil(bags80lb),
...
export default function ConcreteCalculator() {
  return (
    <SimpleCalculator inputs={inputs} calculate={calculate} suffix=" bags" />
  );
}
