...
export default function TaxBracketCalculator() {
  const calculate = (values: number[]) => {
    ...
    return [
      ...
      { result: effectiveRate, label: "Effective tax rate:", suffix: "%", decimals: 1 },
      { result: marginalRate, label: "Marginal tax bracket:", suffix: "%", decimals: 0 },
      { result: afterTaxIncome, label: "After-tax income:", suffix: "$", decimals: 2 },
    ];
  };
