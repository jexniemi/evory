...
const inputs = [
  ...
  { label: "Body weight (kg)", initialValue: 70, step: 1 },
  {
    ...
    labels: ["Strolling (2.5 MET)", "Easy walk (3.0 MET)", "Brisk walk (3.5 MET)", "Fast walk (4.5 MET)", "Power walk (5.0 MET)"],
  },
]
...
const calculate = (values: number[]) => {
  ...
  return [
    { result: calories, label: "Estimated calories burned", suffix: " kcal", decimals: 0 },
    { result: Math.round(distanceKm * 100) / 100, label: "Estimated distance walked", suffix: " km", decimals: 2 },
    { result: Math.round(timeHours * 60), label: "Estimated walking time", suffix: " min", decimals: 0 },
    { result: Math.round((calories / 0.9) * 10) / 10, label: "Approx. grams of fat burned (9 kcal/g)", suffix: " g fat", decimals: 1 },
  ]
}
