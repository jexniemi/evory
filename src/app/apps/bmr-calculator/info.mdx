...
BMR mittaa lepokulutuksen, kun taas TDEE (Total Daily Energy Expenditure) on kokonaiskulutus, joka huomioi kaiken fyysisen aktiivisuuden. Jos haluat tarkan arvion päivittäisestä kalorintarpeestasi, käytä [päivittäinen kalorintarve -laskuria](/apps/paivittainen-kalorintarve-laskuri), jossa voit valita aktiivisuustasosi.
