...
const inputs = [
  {
    label: "Daily calorie maintenance (TDEE, kcal)",
    initialValue: 2200,
    step: 50,
  },
  {
...
const calculate = (values: number[]) => {
  ...
  const weeksToLose5kg =
    Math.round(((5 * 7700) / (dailyDeficit * 7)) * 10) / 10;
  ...
  return [
    {
      ...
      label:
        dailyCalories < 1200
          ? "⚠️ Daily calorie target (too low — increase pace)"
    ...
    {
      result: weeklyLossKg,
      label: "Expected fat loss per week",
      suffix: " kg/week",
      decimals: 2,
    },
    {
      result: weeksToLose5kg,
      label: "Estimated weeks to lose 5 kg",
      suffix: " weeks",
      decimals: 1,
    },
  ];
