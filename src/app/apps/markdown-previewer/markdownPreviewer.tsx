...
function parseMarkdown(md: string): string {
  ...
  // Blockquote
  html = html.replace(/^> (.+)$/gm, '<blockquote class="border-l-4 border-primary pl-4 my-2 opacity-80">$1</blockquote>');
  // Horizontal rule
    ...
    <div className="flex flex-col gap-4 w-full max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="form-control">
          <label className="label"><span className="label-text font-bold">Markdown Input</span></label>
          <textarea
        ...
        <div className="form-control">
          <label className="label"><span className="label-text font-bold">Preview</span></label>
          <div
